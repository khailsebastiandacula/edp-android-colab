...
// TODO 2: Work out the current permission status
...
// TODO 3: A remembered permission you can ask for
@Composable
fun rememberPermission(permission: String): PermissionState {
    ...
    // TODO 3a: rememberLauncherForActivityResult lambda
    ...
    // TODO 3b: LifecycleResumeEffect updates state when screen resumes
    LifecycleResumeEffect(permission) {
        status = activity.permStatus(permission, asked)
        onPauseOrDispose { }
    }

    // TODO 3c: Return state with launcher call wrapped in a lambda
